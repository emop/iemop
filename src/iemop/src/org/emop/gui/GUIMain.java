...
import org.emop.gui.events.EventQueue;
...
public class GUIMain {
	...
	public void startup(){
		...
		eventQueue.registerAction(new EventsHandler(xui, null));		
		/*
		...
		SwingUtilities.invokeLater(new Runnable() {
			public void run(){
				...
				URL layout = this.getClass().getClassLoader().getResource("org/emop/gui/MainFrame.xml");
				if(layout != null) {
					xui.load(layout);	
	...
	private void initWorkDir(){
		String s = System.getProperty("sun.desktop");
		isWin = s != null && s.equals("windows");
		if(isWin){
	...
	private Image appIcon(){
		return MenuToolbar.icon("org/emop/gui/images/freegate.png").getImage();			
	}
